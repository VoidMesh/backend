...
const (
	CharacterSvc_Create_FullMethodName = "/character.v1.CharacterSvc/Create"
	CharacterSvc_List_FullMethodName   = "/character.v1.CharacterSvc/List"
)
...
var CharacterSvc_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "character.v1.CharacterSvc",
